-- Fix assigned_by constraint issue
-- This script makes assigned_by nullable and adds better error handling
...
-- Recreate the table with nullable assigned_by
CREATE TABLE public.senior_assignments (
  ...
  assigned_by UUID, -- Make this nullable
...
-- Verify creation
SELECT 
  'Senior Assignments Fixed' as status,
